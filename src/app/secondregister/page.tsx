      ...
      <form className="px-48 py-24">
        <div>
          ...
          <div className="flex">
            ...
            <p className="text-xl pb-3">
              Te pediremos algunos datos mas para completar tu perfil
            </p>
          </div>
        </div>
        <div className="pb-10">
        ...
        <div>
          ...
          <p className="text-xl pb-10">
            Esta sección podrás completarla ahora, o mas tarde. <br />
            <br />
            <b>
              Recorda que para realizar una reserva, deberás presentar una
