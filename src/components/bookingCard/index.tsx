...
export const BookingCard = ({btn1, btn2}) => {
    return (
        <div className="bg-primary-700 rounded-[20px]">
            <Image
            ...
            />
            <div className="p-5">
                <h3 className="text-center text-[23px] font-bold">CAMIÓN CHICO</h3>
                <hr className="h-[2px] bg-white" />
                <div className="flex flex-col list-inside mt-2 text-[18px]">
                ...
                <div className="flex justify-around mt-9">
                    <button className="text-[23px] font-semibold text-[#FAFAFA]">
                        {btn1}
                    </button>
                    <button className="bg-[#FAFAFA] rounded-[10px] w-[167px] h-[47px] text-primary-600 text-[23px] font-semibold">
                        {btn2}
                    </button>
                </div>
            </div>
