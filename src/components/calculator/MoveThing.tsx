  ...
  return (
    <section className="px-4 py-8">
      ...
      <div className="grid lg:grid-cols-[minmax(100px,_1fr)_400px] gap-2">
        <div className="grid grid-cols-[repeat(auto-fill,minmax(80px,_1fr))] lg:grid-cols-[repeat(auto-fill,minmax(100px,_1fr))] gap-1 md:gap-2 px-1 md:px-4 lg:gap-y-8  bg-primary-700 bg-opacity-80 p-4	 ">
